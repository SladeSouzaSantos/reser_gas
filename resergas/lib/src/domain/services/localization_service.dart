class LocalizationService {
  static const Map<String, Map<String, String>> _translations = {
    'Português': {
      ...
      'erro_soma_hc_menor_igual_zero': 'A composição de gás não possui frações de Hidrocarbonetos (HCs). Favor verificar a entrada de dados.',
      ...
      'unidade_massa_especifica': 'lb/ft³',
      'unidade_viscosidade': 'cP',
      'unidade_compressibilidade': 'psi⁻¹',
    ...
    'Inglês': {
      ...
      'erro_soma_hc_menor_igual_zero': 'The gas composition contains no Hydrocarbon (HC) fractions. Please check the data input.',
      ...
      'unidade_temperatura_r': '°R',
      'unidade_massa_molecular': 'g/mol',
      'unidade_massa_especifica': 'lb/fy³',
      'unidade_viscosidade': 'cP',
      'unidade_compressibilidade': 'psi⁻¹',
      'unidade_fator_volume_formacao': 'ft³/scf',
      'unidade_adimensional': '',
    ...
    'Espanhol': {
      ...
      'erro_soma_hc_menor_igual_zero': 'La composición de gas no tiene fracciones de Hidrocarburos (HC). Por favor, verifique la entrada de datos.',
